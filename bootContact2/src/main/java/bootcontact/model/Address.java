...
public class Address extends AbstractPersistentEntity {
	...
	public Address(Contact contact, String yubin, String todofuken, String sikuchoson,
	...
	public Address(Address address) {
		this(address.getContact(), address.getYubin(), address.getTodofuken(),
	...
	public String toString() {
		return "Address(" + addressType + ":" + id + ")[yubin=" + yubin
				+ ", todofuken=" + todofuken + ", sikuchoson=" + sikuchoson
				+ ", banchi=" + banchi + ", banchi2=" + banchi2 + ", webpage="
				+ webpage + "]";
	}
