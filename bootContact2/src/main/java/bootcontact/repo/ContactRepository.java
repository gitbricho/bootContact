...
public interface ContactRepository extends JpaRepository<Contact, Long> {
    ...
    @Query("select e from Contact e where e.user=:user and e.syubetu=:syubetu")
    public List<Contact> findAll(@Param("user") User user,
            @Param("syubetu") String syubetu, Pageable request);
	...
	public List<Contact> findBySimeiAndSyubetuAndUser(
	        String simei, String syubetu, User user);
