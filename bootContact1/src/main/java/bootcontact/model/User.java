...
public class User extends AbstractPersistentEntity {
    ...
    public String toString() {
        return "User(" + id + ":" + version + ")[" + name + "," + roleList + 
        		", " + roles + ", " + syubetu + "]";
    }
    public String toFullString() {
        return "User(" + id + ":" + version + ")[name=" + name + 
        		", encodePass=" + encodePass + ", roleList=" + roleList + 
        		", roles=" + roles + ", syubetu=" + syubetu + ", theme=" +
        		theme + ", simei=" + simei + ", yomi=" + yomi +
        		", email=" + email + "]";
    }
}
